...
- **Container image must be pre-built:** Agents run inside the `nanoclaw-agent:latest` Docker image. Build it with `./container/build.sh` before attempting end-to-end testing.
