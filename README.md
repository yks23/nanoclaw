...
- **Multi-channel messaging** - Talk to your assistant from WhatsApp, Telegram, Discord, Slack, Gmail, Feishu (飞书), WeChat (微信), or WeCom (企业微信). Add channels with skills like `/add-whatsapp`, `/add-telegram`, `/add-feishu`, `/add-wechat`, or `/add-wecom`. Run one or many at the same time.
